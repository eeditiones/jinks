...
describe("/api/document/{id}", () => {
    ...
    it("retrieves as markdown", () => {
        cy.request("/api/document/auxiliary%2Fteam%2Fwolfgang.md").then(
            ({ status, headers, body }) => {
                expect(status).to.eq(200);
...
describe("/api/document/{id}/html", () => {
    it("retrieves as html", () => {
        cy.request({
            method: "GET",
            url: "/api/document/demo%2FCIDTC-3823-cortez.xml/html",
    ...
    it("retrieves part identified by xml:id as html", () => {
        cy.request({
            method: "GET",
            url: "/api/document/doc%2Finstallation.xml/html",
