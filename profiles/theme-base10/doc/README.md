...
| `colors.palettes.beige`        | _No description available_                                                                           | `"palette-beige.css"`                               |
| `colors.palettes.blue`         | _No description available_                                                                           | `"palette-blue.css"`                                |
| `colors.palettes.green`        | _No description available_                                                                           | `"palette-green.css"`                               |
| `colors.palettes.neutral`      | _No description available_                                                                           | `"palette-neutral.css"`                             |
| `colors.palettes.teal`         | _No description available_                                                                           | `"palette-teal.css"`                                |
...
| `fonts.content.line-height`    | _No description available_                                                                           | `"150%"`                                            |
...
| `layout.footer.mobile.enabled` | _No description available_                                                                           | `true`                                              |
...
| `texture.background-image`     | _No description available_                                                                           | `null`                                              |
