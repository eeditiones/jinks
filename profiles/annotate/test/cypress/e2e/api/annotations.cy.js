...
const uploadAnnotations = () => {
  // Direct REST PUT, not cy.uploadXml(): that command's signature is
  // (url, filename, xml, opts) - multipart, POSTs to an upload endpoint - but this test
  // called it as (path, xmlContent), which silently PUT xmlContent nowhere useful and
  // POSTed to the literal path "annotations.xml" instead (405, since that route doesn't
  // accept POST). Fixed here to write the fixture to the exact path
  // /api/annotations/merge/annotate%2Fannotations.xml expects.
  return cy
    .fixture('annotations.xml', 'utf8')
    .then((xml) => {
      return cy.request({
        method: 'PUT',
        url: 'http://localhost:8080/exist/rest/db/apps/tp-reconc/data/annotate/annotations.xml',
...
describe('/api/annotations/merge', () => {
    ...
    assertAnnotate(
      {
        annotations: [
          ...
          },
          {
            ...
            text: 'Gauger I, 113',
            type: 'link',
            properties: { target: '#foo' },
          },
        ],
      },
      1,
      '<p xmlns="http://www.tei-c.org/ns/1.0">(<ref target="#foo"><hi>Gauger I</hi>, <hi>113</hi></ref>).</p>',
    )
  })
  ...
  it('deletes at end and wraps', () => {
    assertAnnotate(
      ...
      2,
      '<p xmlns="http://www.tei-c.org/ns/1.0">(<ref target="#foo"><hi>113</hi>, <hi>Gauger I</hi></ref>).</p>',
    )
  })
  ...
  it('annotate after nested note', () => {
    assertAnnotate(
      ...
      4,
      '<p xmlns="http://www.tei-c.org/ns/1.0"><ref target="#">Starb am<note place="footnote">Fehlt.</note></ref>. Sammlung: <hi>Opuscula theologica</hi>.</p>',
    )
  })
  ...
  it('annotate after nested choice', () => {
    assertAnnotate(
      ...
      5,
      '<p xmlns="http://www.tei-c.org/ns/1.0"><hi>Zum <choice><abbr>Bsp.</abbr><expan>Beispiel</expan></choice></hi> <hi>Opuscula theologica</hi>.</p>',
    )
  })
        ...
        annotations: [
          {
            ...
            text: 'ipsum dolor',
            type: 'abbreviation',
            properties: { expan: 'sit amet' },
          },
        ],
      },
      6,
      '<p xmlns="http://www.tei-c.org/ns/1.0">Lorem <choice><abbr>ipsum dolor</abbr><expan>sit amet</expan></choice> sit amet.</p>',
    )
  })
        ...
        annotations: [
          {
            ...
            text: 'ipsum dolor',
            type: 'app',
            properties: { 'wit[1]': '#me', 'rdg[1]': 'sit amet' },
          },
        ],
      },
      6,
      '<p xmlns="http://www.tei-c.org/ns/1.0">Lorem <app><lem>ipsum dolor</lem><rdg wit="#me">sit amet</rdg></app> sit amet.</p>',
    )
  })
  ...
  it('delete choice/abbr/expan', () => {
    assertAnnotate(
      ...
      7,
      '<p xmlns="http://www.tei-c.org/ns/1.0">Lorem ipsum dolor sit amet.</p>',
    )
  })
  ...
  it('delete element containing note', () => {
    assertAnnotate(
      ...
      4,
      '<p xmlns="http://www.tei-c.org/ns/1.0">Starb am<note place="footnote">Fehlt.</note>. Sammlung: Opuscula theologica.</p>',
    )
  })
