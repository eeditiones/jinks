...
const uploadAnnotations = () => {
    return cy
        ...
        .then((xml) => {
            return cy.uploadXml("annotations.xml", xml);
        })
        .then(({ status, body }) => {
            cy.wrap(status).should("eq", 200);
            cy.wrap(body).its("path").should("include", "annotations.xml");
        });
};
...
describe("/api/annotations/merge", () => {
    ...
    it("delete choice/abbr/expan", () => {
        assertAnnotate(
            {
                annotations: [{ type: "delete", node: "1.4.2.14.2", context: "1.4.2.14" }],
            },
            7,
    ...
    it("delete element containing note", () => {
        assertAnnotate(
            {
                annotations: [{ type: "delete", node: "1.4.2.8.1", context: "1.4.2.8" }],
            },
            4,
