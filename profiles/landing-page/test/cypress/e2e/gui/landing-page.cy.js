...
describe("TEI-Publisher Landing Page", () => {
    ...
    describe("Hero Section", () => {
        it("displays hero section", () => {
            ...
            cy.get('header.hero, .hero, [class*="hero"]').should("exist").should("be.visible");
        });
        ...
        it("displays explore link", () => {
            ...
            cy.get('header.hero .button-link, .hero a[href*="highlights"], a.button-link').should(
                "exist",
            );
        });
    ...
    describe("Landing Page Sections", () => {
        it("displays about section when present", () => {
            ...
            cy.get("body").then(($body) => {
                const hasAboutSection =
                    $body.find('[class*="about"], section[class*="about"]').length > 0;

                if (hasAboutSection) {
                    cy.get('[class*="about"], section[class*="about"]').should("be.visible");
                } else {
        ...
        it("displays highlights section when present", () => {
            ...
            cy.get("body").then(($body) => {
                const hasHighlights =
                    $body.find('[class*="highlight"], section[class*="highlight"]').length > 0;

                if (hasHighlights) {
                    cy.get('[class*="highlight"], section[class*="highlight"]').should(
                        "be.visible",
                    );
                } else {
        ...
        it("displays feature image when present", () => {
            ...
            cy.get("body").then(($body) => {
                ...
                if (images.length > 0) {
                    cy.get("img").first().should("be.visible").should("have.attr", "src");
                } else {
    ...
    describe("Navigation Elements", () => {
        it("displays app header/navigation", () => {
            ...
            cy.get('app-header, nav, header, [role="banner"]').should("exist");
        });
    ...
    describe("Landing Page Features", () => {
        ...
        it("displays main content", () => {
            ...
            cy.get("main, body").should("not.be.empty").invoke("text").should("not.be.empty");
        });
    });
});
