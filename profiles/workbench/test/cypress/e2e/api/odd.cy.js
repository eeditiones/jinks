...
describe("/api/odd [authenticated]", () => {
    ...
    it("retrieves a list of odds", () => {
        cy.request("/api/odd").its("status").should("eq", 200);

        cy.request("/api/odd").its("body").should("be.an", "array");
