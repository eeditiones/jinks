...
describe("TEI-Publisher ODD Editor", () => {
    ...
    describe("ODD Editor Page Load", () => {
        ...
        it("displays ODD editor component", () => {
            cy.get("pb-odd-editor", { timeout: 10000 }).should("exist").should("be.visible");
        });

        it("shows ODD name in header", () => {
            cy.get("pb-odd-editor").find("h3 span").should("exist").should("not.be.empty");
        });
    });

    describe("ODD Editor Navigation", () => {
        it("displays navigation drawer with element list", () => {
            cy.get("pb-odd-editor", { timeout: 10000 }).should("exist");
    ...
    describe("ODD Editor Toolbar", () => {
        ...
        it("shows save button", () => {
            ...
            cy.get("pb-odd-editor")
                .shadow()
                .find(
                    'paper-icon-button[icon="save"], button[title*="save"], button[title*="Save"]',
                )
                .should("exist");
        });
        ...
        it("shows reload button", () => {
            ...
            cy.get("pb-odd-editor")
                .shadow()
                .find(
                    'paper-icon-button[icon="refresh"], button[title*="reload"], button[title*="Reload"]',
                )
                .should("exist");
        });
        ...
        it("shows edit source button", () => {
            ...
            cy.get("pb-odd-editor")
                .shadow()
                .find(
                    'paper-icon-button[icon="code"], button[title*="source"], button[title*="ODD Source"]',
                )
                .should("exist");
        });
    });
        ...
        it("shows element details when selected", () => {
            ...
            cy.get("pb-odd-editor").then(($editor) => {
                ...
                if (navItems.length > 0) {
                    ...
                    cy.get("pb-odd-editor .specs, pb-odd-editor section", {
                        timeout: 10000,
                    }).should("exist");
                } else {
        ...
        it("displays element metadata when available", () => {
            ...
            cy.get("pb-odd-editor").then(($editor) => {
                ...
                if (metadataCards.length > 0) {
                    cy.get(".metadata-card").should("exist");
                } else {
    ...
    describe("ODD Editor Add Element", () => {
        it("displays add element input", () => {
            ...
            cy.get("pb-odd-editor").contains("Add Element").parent().find("input").should("exist");
        });
    ...
    describe("ODD Editor Save Functionality", () => {
        ...
        it("can trigger save action", () => {
            ...
            // Save button is in Shadow DOM
            cy.get("pb-odd-editor").shadow().find('paper-icon-button[icon="save"]').should("exist");
        });
    });
