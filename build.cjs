...
const sassOutputDirs = ["profiles/theme-base10/resources/css"];
...
build({
    entryPoints: ["resources/scripts/jinn-monaco.js"],
    bundle: true,
    format: "esm",
    minify: true,
    outdir: path.join(__dirname, "resources/scripts/dist"),
...
try {
    execSync(
        "node profiles/theme-base10/generate-theme-docs.js -c profiles/landing-page/config.json profiles/landing-page/doc",
        {
            cwd: __dirname,
            stdio: "inherit",
        },
    ...
    execSync(
        "node profiles/theme-base10/generate-theme-docs.js -c profiles/theme-base10/config.json profiles/theme-base10/doc",
        {
            cwd: __dirname,
            stdio: "inherit",
        },
